...
@WebServlet(name = "E1_ConsultaVentaControlador", urlPatterns = {"/E1_ConsultaVentaControlador"})
public class E1_ConsultaVentaControlador extends HttpServlet {
        ...
        try {
            ...
            switch (action) {
                ...
                case "delete":
                    ...
                    response.sendRedirect("E1_ConsultaVentaControlador");
                    break;
                case "view":
                    //Obtener la lista de registros
                    List<Usuario> lista = dao.getAll();
                    request.setAttribute("consultaventas", lista);
                    request.getRequestDispatcher("e1_consultaVentas.jsp").forward(request, response);
                    break;
                default:
                    break;
            }
